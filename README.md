...
- [Logdy](https://logdy.dev) - Web-based real-time log viewer. Stream ANY content to a web UI with autogenerated filters. Parse any format with TypeScript. ([Demo](https://demo.logdy.dev/), [Source code](https://github.com/logdyhq/logdy-core)) `Apache-2.0` `Go`
